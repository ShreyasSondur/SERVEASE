                ...
                <div className="flex flex-col flex-1 py-1">
                  ...
                  <div className="flex items-center gap-4 md:gap-6 mt-3 md:mt-4 pt-3 md:pt-4">
                    <div className="flex items-center gap-1.5 md:gap-2 text-white/80">
                      ...
                      <span className="text-[12px] md:text-[13px] font-medium tracking-wide truncate max-w-[120px] sm:max-w-none">{service.location}</span>
                    </div>
                    <div className="flex items-center gap-1.5 md:gap-2 text-white/80">
                      <Calendar className="w-3.5 h-3.5 md:w-[14px] md:h-[14px] text-white/50" strokeWidth={2} />
                      <span className="text-[12px] md:text-[13px] font-medium tracking-wide">{service.date}</span>
                    </div>
                  </div>
                </div>
