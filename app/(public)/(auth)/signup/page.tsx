    ...
    <div className="relative min-h-screen bg-[#111111] flex flex-col w-full font-sans">
      ...
      <main className="flex-grow flex items-center justify-center pt-28 pb-20 px-4 sm:px-6 relative z-10">
        <div className="w-full max-w-md bg-[#1a1a1a] rounded-2xl shadow-2xl p-6 sm:p-8 md:p-8 border border-[#2a2a2a]">
          ...
          {/* Google Button */}
          <button className="cursor-pointer w-full bg-[#1c1c1c] hover:bg-[#252525] text-[#D4D2CD] border border-[#333] rounded-xl py-3 flex items-center justify-center gap-3 transition-colors mb-5 font-medium text-[14px] sm:text-[15px]">
          ...
          <div className="relative flex items-center justify-center mb-5">
            ...
            <span className="relative bg-[#1a1a1a] px-4 text-[#555] text-xs font-semibold tracking-wider uppercase">
              OR
            </span>
          </div>
          ...
          <form className="flex flex-col gap-2.5">
            ...
            {/* Submit Button */}
            <button className=" cursor-pointer w-full bg-[#d4933a] hover:bg-[#c28532] text-white font-semibold py-3 rounded-xl transition-colors text-[14px] sm:text-[15px] shadow-lg mt-1.5">
              Create Account
            </button>
          </form>
