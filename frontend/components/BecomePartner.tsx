...
export default function BecomePartner() {
    return (
        <section className="w-full mx-auto px-4 sm:px-6 lg:px-12 py-8 sm:py-12 flex justify-center bg-transparent">
            <div className="relative w-full max-w-[1200px] rounded-2xl sm:rounded-[20px] overflow-hidden border border-white/5 bg-[#131313] min-h-[450px] sm:min-h-[500px] lg:min-h-[600px] flex items-stretch">
                ...
                {/* Content */}
                <div className="relative z-10 w-full md:w-[65%] lg:w-[60%] flex flex-col justify-end sm:justify-start px-5 sm:pl-8 md:pl-10 lg:pl-16 pr-5 sm:pr-6 pb-8 sm:pb-12 pt-8 sm:pt-12 md:pt-16">
                    <p className="text-[#C58434] font-sans text-[10px] sm:text-xs lg:text-[13px] font-semibold tracking-[0.2em] uppercase mb-6 sm:mb-10">
                        Become a Partner
                    </p>
                    <h2 className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-[56px] font-serif font-normal leading-tight lg:leading-[1.1] mb-4 sm:mb-6">
                        Grow your business.<br />
                        Reach <span className="text-[#C58434]">more customers.</span>
                    </h2>
                    <p className="text-[#A3A3A3] font-sans text-xs sm:text-sm lg:text-[15px] font-light max-w-[480px] leading-relaxed mb-8 sm:mb-12 lg:mb-24">
                        List your services on our platform and get discovered by people who need professionals like you
                    </p>

                    {/* Features Row */}
                    <div className="flex flex-row items-start justify-between w-full max-w-[400px] sm:max-w-[480px] mb-6 sm:mb-4 lg:mb-12">
                        <div className="flex flex-col items-center text-center gap-2 sm:gap-3 w-[90px] sm:w-[120px]">
                        ...
                        <div className="w-[1px] h-8 sm:h-10 bg-white/10 mt-1"></div>
