  ...
  if (success) {
    return (
      <div className="relative min-h-screen bg-[#0b0a0a] flex items-center justify-center font-sans p-4">
        ...
        <div className="w-full max-w-md bg-black/80 backdrop-blur-xl border border-[#222] rounded-[2rem] shadow-2xl p-8 text-center relative z-10">
          ...
          <div className="w-16 h-16 bg-[#d4933a]/10 rounded-full flex items-center justify-center mx-auto mb-6 border border-[#d4933a]/20">
             <ShieldCheck className="w-8 h-8 text-[#d4933a]" />
          </div>
      ...
      <div className="w-full max-w-md bg-black/80 backdrop-blur-xl border border-[#222] rounded-[2rem] shadow-2xl p-8 relative overflow-hidden z-10">
        ...
        <div className="text-center mb-8">
          <div className="w-12 h-12 bg-[#d4933a]/10 rounded-xl flex items-center justify-center mx-auto mb-4 border border-[#d4933a]/20">
            <ShieldCheck className="w-6 h-6 text-[#d4933a]" strokeWidth={2} />
          </div>
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSignup}>
          <div className="flex flex-col gap-1.5">
            <label className="text-white text-xs uppercase tracking-wider font-bold">Full Name</label>
            <div className="relative">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#555]" strokeWidth={2} />
              <input
                type="text"
                value={fullName}
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-white text-xs uppercase tracking-wider font-bold">Confirm Password</label>
            <div className="relative">
              <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#555]" strokeWidth={2} />
              <input
